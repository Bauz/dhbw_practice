...
public class SchwarzWeissFrame extends JFrame {
	...
	public SchwarzWeissFrame(int width, int height) {
		...
		// neuen Button erzeugen und listener für Action (button geklickt)
		// hinzugefügt
	...
	private class ButtonBearbeiter implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			// Quellkomponente des Events ermitteln, casten, hintergrundfarbe
			// setzen
	...
	private class MausBearbeiter implements MouseListener {
		...
		public void mousePressed(MouseEvent e) {
			// Quellkomponente des Events ermitteln, casten, hintergrundfarbe
			// setzen
			((SchwarzWeissFrame) e.getSource()).getContentPane().setBackground(
					Color.WHITE);
		}
