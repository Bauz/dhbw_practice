...
public abstract class Zahl {
	...
	/**
	 * f¸hrt eine Addition durch und liefert die Summe (ausf¸hrendes Objekt +
	 * Parameter-Objekt) als neues Objekt zur¸ck
	 */
	public abstract Zahl add(Zahl zahl);

	/**
	 * f¸hrt eine Subtraktion durch (unter Verwendung von add und neg) und
	 * liefert die Differenz (ausf¸hrendes Objekt - Parameter-Objekt) als neues
	 * Objekt zur¸ck
	 */
